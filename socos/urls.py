...
router.register("pensen", api.PensumViewSet, basename="pensum")
...
router.register("meetings", api.MeetingViewSet, basename="meeting")
router.register("meetingabschnitte", api.MeetingabschnittViewSet, basename="meetingabschnitt")
router.register("meetinganhaenge", api.MeetinganhangViewSet, basename="meetinganhang")
